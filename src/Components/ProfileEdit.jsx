        ...
        <>
            ...
            {isOpen && (
                <div className="z-50 fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50">
                    <div className=" max-h-[370px] lg:w-1/2 w-full overflow-y-auto border p-8 bg-white shadow-xl rounded-md register-form">
                        <h2 className="text-2xl font-bold mb-4 text-primaryColor ">Update</h2>
                        <div className=''>
                            <div className="mb-4">
                        ...
                        <div className='flex gap-3 justify-end' >
                            ...
                            <button onClick={() => setIsOpen(false)} className='bg-gray-400 rounded-md px-4 text-white' >Cancel</button>
                        </div>
            ...
            <button onClick={() => setIsOpen(true)} >
                {loading ? 'Updating...' : <FaEdit className='text-2xl text-primaryColor' />}
            </button>
        </>
    );
};
